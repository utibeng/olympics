...
import com.utibe.olympics.loadtables.output.tables.olympicevents.OlympicEvents;
import com.utibe.olympics.loadtables.output.tables.olympicevents.OlympicEventsFilterProcessor;
import com.utibe.olympics.loadtables.output.tables.olympicevents.OlympicEventsJobCompletionNotificationListener;
import com.utibe.olympics.loadtables.output.tables.olympicevents.OlympicEventsProcessor;
...
public class BatchConfigurationOlympicEvents {
    ...
    public JdbcBatchItemWriter<OlympicEvents> writerOlympicEvents(DataSource dataSource) {
        return new JdbcBatchItemWriterBuilder<OlympicEvents>()
                ...
                .sql("INSERT INTO olympics_olympicevents (sport, event, year, games, season) " +
