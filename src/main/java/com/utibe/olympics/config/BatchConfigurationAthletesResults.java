...
import com.utibe.olympics.output.tables.athletesresults.AthletesResults;
import com.utibe.olympics.output.tables.athletesresults.AthletesResultsFilterProcessor;
import com.utibe.olympics.output.tables.athletesresults.AthletesResultsJobCompletionNotificationListener;
import com.utibe.olympics.output.tables.athletesresults.AthletesResultsProcessor;
...
public class BatchConfigurationAthletesResults {
    ...
    public JdbcBatchItemWriter<AthletesResults> writerAthletesResults(DataSource dataSource) {
        return new JdbcBatchItemWriterBuilder<AthletesResults>()
                ...
                .sql("INSERT INTO athletesresults (id, noc, games, event, medal, sex, age, height, weight) " +
